...
{{-- {{ ($name) }} --}}
{{-- 
<a href="{{ route('blog.index') }}">Click Here</a> --}}

{{-- Naming a route with a parameter --}}
{{-- <a href="{{ route('blog.show',['id' => 1]) }}">Click Here instead</a> --}}

{{-- Blade variable and Control structure  --}}
<html>
<head>
    <meta charset="UTF-8">
    <meta
    ...
    <link
        rel="stylesheet"
        href="{{ asset('resources/css/app.css') }}"
    />
    <style>
...
<body class="w-full h-full bg-gray-100">
    ...
    {{-- Deleting Data using Eloquent:Delete message --}}
